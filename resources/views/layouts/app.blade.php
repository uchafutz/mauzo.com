            ...
            <div class="app-sidebar">
                ...
                <div class="app-menu">
                    <ul class="accordion-menu">
                        ...
                        <li>
                            <a href="{{ route("purchase.purchases.index") }}"><i class="material-icons-two-tone">shopping_cart</i>Purchases</a>
                        </li>
                        <li>
                            <a href="#"><i class="material-icons-two-tone">precision_manufacturing</i>Manufacturing</a>
                        </li>
                        <li>
                            <a href="mailbox.html"><i class="material-icons-two-tone">groups</i>Customers</a>
                        </li>
                        <li>
                            <a href=""><i class="material-icons-two-tone">warehouse</i>Inventory<i class="material-icons has-sub-menu">keyboard_arrow_right</i></a>
                            <ul class="sub-menu">
                                <li>
                                    <a href="pricing.html">Categories</a>
                                </li>
                                <li>
                                    <a href="invoice.html">Items</a>
                                </li>
                                <li>
                                    <a href="invoice.html">Warehouses</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li>
                                    <a href="invoice.html">Roles</a>
                                </li>
                                <li>
                                    <a href="invoice.html">Units</a>
                                </li>
                                <li>
                                    <a href="invoice.html">Unit Types</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-flex">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item hidden-on-mobile">
                                        <a class="nav-link language-dropdown-toggle" href="#" id="languageDropDown" data-bs-toggle="dropdown"><i class="material-icons">settings</i></a>
