            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @isset($role)
                            <form action="{{ route('config.roles.update', ['role' => $role]) }}" method="POST"
                            ...
                            @else
                                ...
                                <x-form.custom-input name="display" type="text" label="Display" placeholder=""
                                    value="{{ isset($role) ? $role->display : null }}" />
