                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            <tr>
                                <th>Item</th>
                                <td><a
                                        href="{{ route('inventory.inventoryItems.show', ['inventoryItem' => $manufacturing->item]) }}">{{ $manufacturing->item->name }}</a>
                                </td>
                            </tr>
                            <tr>
                                <th>Quantity</th>
                                            ...
                                            @if ($material->type == 'WASTAGE')
                                                <tr>
                                                    ...
                                                    <td>{{ $material->quantity }}
                                                        {{ $material->materialItem->unit->code }}</td>
                                                </tr>
                                            @endif
                                        @endforeach
                                    </tbody>
                ...
                <form x-bind:action="url" method="post">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h5 class="text-green">Total Quantity Contributed: <span
                                    x-text="stock_items.reduce((c, i) => c + parseInt(i.contribution),0)"></span></h5>
                            <table class="table">
                                <thead>
                                    <th>S/N</th>
                                    <th>Date</th>
                                ...
                                <tbody>
                                    <template x-for="(item, i) in stock_items">
                                        <tr>
                                            ...
                                            <td>
                                                <input type="hidden" x-bind:name="item.stock_item_name"
                                                    x-bind:value="item.id">
                                                <input type="number" class="form-control"
                                                    x-bind:name="item.contribution_name"
                                                    x-model="stock_items[i].contribution">
                                            </td>
                                        </tr>
                                    </template>
                                </tbody>
    ...
    <script>
        function getModalState() {
            return {
                ...
                quantity_required: 0,
                stock_items: [],
                setValues(url, quantity_required, stock_items) {
                    this.url = url;
