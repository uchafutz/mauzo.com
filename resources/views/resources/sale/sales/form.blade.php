                ...
                <div class="card">
                    ...
                    <div class="card-body" x-data="getState()" x-init="initialize({{ json_encode($items) }}, {{ json_encode($units) }}, {{ json_encode($customers) }},{{ isset($sale) ? json_encode($sale->items) : json_encode([]) }})">
                        ...
                        @endisset
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <x-form.custom-input type="date" name="date" label="Sale Date" value="{{ isset($sale) ? $sale->date->format('Y-m-d') : date('Y-m-d') }}" />
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <x-form.custom-textarea name="description" label="Sale Descriptin" value="{{ isset($sale) ? $sale->description : '' }}" />
                            </div>
