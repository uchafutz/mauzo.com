                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <x-form.custom-input type="text" name="received_amount" label="Received Amount" x-model="received_amount" x-init="received_amount = {{ old('received_amount') }}" />
                                </div>
                            ...
                            <input type="hidden"
                                        name="return_amount"
                                        x-bind:value="received_amount - total">
